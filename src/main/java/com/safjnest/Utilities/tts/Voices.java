...
public class Voices {
  public class English_UnitedStates {
    ...
    public static final String[] array = {"Linda", "Amy", "Mary", "John" ,"Mike"};
  ...
  public class Russian {
    ...
    public static final String[] array = {"Olga", "Marina", "Peter"};
  ...
  public class Danish {
    ...
    public static final String[] array = {"Freja"};
  ...
  public class German_Austria {
    ...
    public static final String[] array = {"Lukas"};
  ...
  public class English_Australia {
    ...
    public static final String Isla = "Isla";

    public static final String Evie = "Evie";
  ...
  public class English_GreatBritain {
    ...
    public static final String Nancy = "Nancy";
  ...
  public class English_India {
    ...
    public static final String Ajit = "Ajit";
  ...
  public class Spanish_Spain {
    ...
    public static final String Sofía = "Sofía";
  ...
  public class Spanish_Mexico {
    ...
    public static final String Silvia = "Silvia";

    public static final String Teresa = "Teresa";

    public static final String Jose = "Jose";

    public static final String[] array = {"Juana", "Silvia", "Teresa", "Jose"};
  ...
  public class French_Canada {
    ...
    public static final String[] array = {"Emile", "Olivia", "Felix", "Logan"};
  ...
  public class French_France {
    ...
    public static final String Axel = "Axel";
  ...
  public class French_Switzerland {
    ...
    public static final String[] array = {"Theo"};
  ...
  public class Japanese {
    ...
    public static final String Airi = "Airi";

    public static final String Akira = "Akira";

    public static final String Fumi = "Fumi";
  ...
  public class Norwegian {
    ...
    public static final String Erik = "Erik";
  ...
  public class Dutch_Belgium {
    ...
    public static final String[] array = {"Daan"};
  }
  ...
  public class Portuguese_Brazil {
    ...
    public static final String Ligia = "Ligia";

    public static final String Dinis = "Dinis";

    public static final String Yara = "Yara";
  ...
  public class Catalan {
    ...
    public static final String[] array = {"Rut"};
  ...
  public class Swedish {
    ...
    public static final String[] array = {"Hugo", "Molly"};
  ...
  public class Hindi {
    ...
    public static final String Kabir = "Kabir";
  ...
  public class Vietnamese {
    ...
    public static final String[] array = {"Chi"};
  }
}


/* Location:              C:\Users\leona\Desktop\voicerss_tts.jar!\com\voicerss\tts\Voices.class
