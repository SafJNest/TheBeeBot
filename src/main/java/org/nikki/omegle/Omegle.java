...
public class Omegle implements Runnable {
	 ...
	 * The base omegle url
	 */
	public static String BASE_URL = "https://omegle.com";
	...
	public OmegleSession openSession(OmegleMode mode, Object... objs)
		...
		try {
			...
			url = new URL("https://" + resp.getJSONArray("antinudeservers").get(0).toString() + "/check");
			String cc = HttpUtil.post(url, "");
			
			Map<String, Object> vars = new HashMap<String, Object>();
			vars.put("caps", "recaptcha2,t3");
			vars.put("rcs", "1");
			vars.put("firstevents", firstEvents ? "1" : "0");
			vars.put("cc", cc);
			//vars.put("topics", "[\"bababoiasdijn2\"]");
			//vars.put("lang", lang);
			...
			url = new URL(OPEN_URL + "?" + HttpUtil.implode(vars));

			resp = new JSONObject(HttpUtil.post(url, ""));
	...
	public OmegleSession openSessionSafJ(OmegleMode mode, Object... objs) throws OmegleException {
		try {
			...
			vars.put("firstevents", firstEvents ? "1" : "0");
			vars.put("cc", cc);
			vars.put("lang", objs[0].toString());
			vars.put("topics", objs[1].toString());
